...
export default function ModeratorManageBlogPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <header className="flex items-center justify-between mb-6">
          ...
          <a href="/dashboard/moderator/create/blog" className="bg-teal-600 text-white px-4 py-2 rounded-lg">+ Add Blog</a>
        </header>

        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          {blogs.length === 0 ? <div className="p-8 text-center text-gray-500">No blogs found</div> : (
